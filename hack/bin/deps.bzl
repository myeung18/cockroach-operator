...
def install_openshift():
    http_archive(
       ...
       urls = ["https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.7.9/openshift-client-mac-4.7.9.tar.gz"],
       build_file_content = """
filegroup(
    name = "file",
    srcs = [
...
""",
    ...
    http_archive(
        ...
        sha256 = "136e7252581df48ac960f7c005eca5561f141842436bae5b154e223d7a10415b",
        urls = ["https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.7.9/openshift-client-linux-4.7.9.tar.gz"],
        build_file_content = """
filegroup(
    name = "file",
    srcs = [
